  ...
  <q-layout view="lHh Lpr lFf">
          ...
          <q-menu>
            <q-list>
              <q-item clickable v-close-popup to="/">
                <q-item-section>New Quote</q-item-section>
              </q-item>
    ...
    >
      <q-list>
        ...
        <q-item clickable v-ripple to="/admin/pricing">
          <q-item-section avatar>
            <q-icon name="admin_panel_settings" />
          </q-item-section>
          <q-item-section>Admin Pricing</q-item-section>
        </q-item>
      </q-list>
    </q-drawer>
    ...
    <q-footer elevated class="bg-dark text-white q-pa-sm">
      <div class="text-center text-caption">
        TicTacStick v2.0 · © 2025 925 Pressure Glass
      </div>
    </q-footer>
  </q-layout>
</template>
